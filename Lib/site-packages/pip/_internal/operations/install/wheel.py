...
def message_about_scripts_not_on_PATH(scripts):
    ...
    """Determine if any models are not on PATH and format a warning.
    Returns a warning message if one or more models are not on PATH,
    otherwise None.
    """
    if not scripts:
        return None

    # Group models by the path they were installed in
...
def install_unpacked_wheel(
    ...
    :param warn_script_location: Whether to check that models are installed
    ...
    #   changed = files changed while installing (models #! line typically)
    ...
    def is_entrypoint_wrapper(name):
        # type: (str) -> bool
        # EP, EP.exe and EP-script.py are models generated for
        ...
        if name.lower().endswith('.exe'):
            ...
            matchname = name
        # Ignore setuptools-generated models
    ...
    # Ensure old models are overwritten.
    # See https://github.com/pypa/pip/issues/1800
    maker.clobber = True

    # Ensure we don't generate any variants for models because this is almost
    # never what somebody wants.
    # See https://bitbucket.org/pypa/distlib/issue/35/
    maker.variants = {''}

    # This is required because otherwise distlib creates models that are not
    # executable.
    ...
    # variable which will control which version models get installed.
    #
    ...
    try:
        ...
        raise InstallationError(
            ...
            "specifications/entry-points/#use-for-models for more "
